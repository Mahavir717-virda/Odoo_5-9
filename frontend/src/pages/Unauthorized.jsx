...
export default function Unauthorized() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-slate-50 p-4">
      <div className="max-w-sm w-full bg-white shadow-sm rounded-xl p-8 text-center border border-slate-200">
        ...
        <button
          ...
          className="w-full py-2.5 px-4 text-sm font-semibold text-white bg-[#7743db] rounded-lg hover:bg-[#6334b8] active:bg-[#4f2795] focus:outline-none focus:ring-2 focus:ring-[#7743db] focus:ring-offset-1 transition-colors shadow-sm"
        >
          Return to Dashboard
        </button>
      </div>
